...
pactWith(
  {
    consumer:
      'product-of-the-main-diagonal-of-a-square-matrix-typescript_client',
    provider: 'product-of-the-main-diagonal-of-a-square-matrix-typescript_app',
  },
  (provider: Pact) => {
    describe('Product of the main diagonal of a square matrix - TypeScript API', () => {
      ...
      describe('App API', () => {
        beforeEach(() => {
          return provider.addInteraction({
            state: 'Initial state',
            uponReceiving:
              'a request for the product-of-the-main-diagonal-of-a-square-matrix-typescript API',
            withRequest: {
              method: 'GET',
              path: '/api/v1/dummy',
            },
