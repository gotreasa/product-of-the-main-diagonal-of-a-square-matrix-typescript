...
The following is a set of guidelines for contributing to Product of the main diagonal of a square matrix - TypeScript.
...
## How to contribute to Product of the main diagonal of a square matrix - TypeScript
